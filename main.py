...
GRASS = scale_img(pygame.image.load("imgs/grass.jpeg"), 2.5)
...
GREY_CAR = scale_img(pygame.image.load("imgs/grey-car.png"), 0.55)
WHITE_CAR = scale_img(pygame.image.load("imgs/white-car.png"), 0.55)

WIDTH, HEIGHT = TRACK.get_width(), TRACK.get_height()
WIN = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("F1 2021")
...
class ComputerCar(AbstractCar):
    ...
    def draw(self, win):
        super().draw(win)
        # self.draw_points(win)  # Draws points on the screen
...
def handle_collision(player_car, computer_car, game_info):
    ...
    if player_car.collide(TRACK_BORDER_MASK) != None:
        # print("You don't know how to drive")
        player_car.bounce()  # bouncy
    ...
    if player_finish_poi_collide != None:  # "*" is basically the coords of the finish
